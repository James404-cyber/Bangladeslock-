...
\033[1;96m══▒█▄─▄─▀██▀▄─██▄─▀█▄─▄█─▄▄▄▄█▄─▄████▀▄─██  \033[1;92mJAMES HACKER UPDATE COMMANDS 🦇
\033[1;91m══▒██─▄─▀██─▀─███─█▄▀─██─██▄─██─██▀██─▀─██  \033[1;93mWE ARE BANGLADESH.    🦇
\033[1;96m══▒▀▄▄▄▄▀▀▄▄▀▄▄▀▄▄▄▀▀▄▄▀▄▄▄▄▄▀▄▄▄▄▄▀▄▄▀▄▄▀  \033[1;94mWE ARE BD TIGERS.  🦇

\033[1;96m══║══▒═💀═▒═💀═▒═══¤═¤═¤═════════════════════║🔥
\033[1;96m══║✯𝖈𝖗𝖊𝖆𝖙𝖔𝖗 ☪ JAMES HACKER ║🔥
\033[1;96m══║✯ 𝖄𝖔𝖚𝖙𝖚𝖇𝖊 ☪ Technical James║🔥
\033[1;96m══║✯ℑ,𝔪 𝔫𝔬𝔱 𝔯𝔢𝔰𝔭𝔬𝔫𝔰𝔦𝔟𝔩𝔢 𝔞𝔫𝔶 𝔪𝔦𝔰𝔰 𝔲𝔰𝔢  ☪║🔥
\033[1;96m══║══▒═💀═▒═💀═▒═══¤═¤═¤═════════════════════║🔥"""

jalan("\033[1;96m▬▬▬▬▬ 𝐅𝐨𝐫 𝐚𝐧𝐲 𝐡𝐞𝐥𝐩 𝐫𝐞𝐪𝐮𝐞𝐬𝐭 𝐦𝐞  ")
jalan("\033[1;96m▬▬▬▬▬ 𝚆𝚑𝚊𝚝𝚜𝙰𝚙𝚙 𝚗𝚞𝚖𝚋𝚎𝚛 》+96598064347")
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;94m•◈••◈••◈•\033[1;95m█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄█\033[1;94m•◈••◈••◈•
\033[1;94m•◈••◈••◈••◈•\033[1;94m••◈••◈••◈••◈••◈••◈••◈••◈•\033[1;94m•◈••◈••◈••◈•
\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;96mJames Hacker\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"""
jalan('\033[1;96m▬10%')
jalan("\033[1;96m▬▬20%")
jalan('\033[1;96m▬▬▬30%')
jalan('\033[1;96m▬▬▬▬40%')
...
jalan('\033[1;96m▬▬▬▬▬▬▬▬▬90%')
jalan('\033[1;96m▬▬▬▬▬▬▬▬▬100%')
print "\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•\033[1;96mJames.Hacker\033[1;91m•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•"

CorrectUsername = "lock"
CorrectPassword = "profile"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.youtube.com/channel/be/w2_ZtfB51vA')
    else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.Facebook.com/Om6t')
...
def pilih_super():
	...
	jalan('             \033[1;31mJames Mafia  Started Cloning  Wait...')
	print  "\033[1;36;40m ●💀════════════════════════◄🦇►════════════════════════💀●" 
